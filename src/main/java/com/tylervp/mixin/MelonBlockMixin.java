...
import com.tylervp.block.CarvedMelonBlock;
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (itemStack8.getItem() == Items.SHEARS) {
            if (!world.isClient) {
                ...
                world.setBlockState(pos,  (BlockState)MBMBlocks.CARVEDMELON.getDefaultState().with(CarvedMelonBlock.FACING, player.getHorizontalFacing().getOpposite()), 11);
