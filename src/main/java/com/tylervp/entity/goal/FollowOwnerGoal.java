 ...
 */
package com.tylervp.entity.goal;
...
extends Goal {
    ...
    private final AgentEntity tameable;
    ...
    public FollowOwnerGoal(AgentEntity tameable, double speed, float minDistance, float maxDistance, boolean leavesAllowed) {
    ...
    public boolean shouldContinue() {
        ...
        return !(this.tameable.squaredDistanceTo(this.owner) <= (double)(this.maxDistance * this.maxDistance))/*  && (this.tameable.getOnStatus() && this.tameable.getStartMovetoEntity()) */;
    }

    private boolean cannotFollow() {
        return !(this.tameable.getOnStatus() && this.tameable.getStartMovetoEntity()); //this.tameable.isSitting() || this.tameable.hasVehicle() || this.tameable.isLeashed()
    }
