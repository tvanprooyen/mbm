...
public class PetrifiedBlock extends Block {
    ...
    protected PetrifiedBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    private void breakPetrifiedBlock(World world, BlockPos pos, BlockState state) {
        ...
        int integer5 = state.<Integer>get((Property<Integer>)PetrifiedBlock.BREAKSTATE);
        if (integer5 <= 1) {
