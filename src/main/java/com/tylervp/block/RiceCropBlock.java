...
public class RiceCropBlock extends Block implements Fertilizable {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return RiceCropBlock.AGE_TO_SHAPE[state.<Integer>get((Property<Integer>)this.getAgeProperty())];
    }
    ...
    public BlockState withAge(int age, BlockState state) {
        return ((BlockState)this.getDefaultState()).with(this.getAgeProperty(), age).with(RiceCropBlock.FLIP, state.get(RiceCropBlock.FLIP));
    }
    ...
    protected void appendProperties(StateManager.Builder<Block, BlockState> builder) {
        builder.add(RiceCropBlock.AGE, RiceCropBlock.FLIP);
    }
    
    static {
        AGE = Properties.AGE_7;
        FLIP = BooleanProperty.of("flip");
