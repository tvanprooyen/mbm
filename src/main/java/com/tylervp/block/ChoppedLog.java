...
public class ChoppedLog extends Block {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if(state.isOf(this)) {
            ...
            if(!(state.isOf(MBMBlocks.CHOPPED_STRIPPED_ACACIA_LOG) || state.isOf(MBMBlocks.CHOPPED_STRIPPED_BIRCH_LOG) || state.isOf(MBMBlocks.CHOPPED_STRIPPED_DARK_OAK_LOG)  || state.isOf(MBMBlocks.CHOPPED_STRIPPED_JUNGLE_LOG)  || state.isOf(MBMBlocks.CHOPPED_STRIPPED_OAK_LOG)  || state.isOf(MBMBlocks.CHOPPED_STRIPPED_SPRUCE_LOG))) {
                if ((playerItem.getItem() == Items.WOODEN_AXE || playerItem.getItem() == Items.STONE_AXE || playerItem.getItem() == Items.GOLDEN_AXE || playerItem.getItem() == Items.IRON_AXE || playerItem.getItem() == Items.DIAMOND_AXE || playerItem.getItem() == Items.NETHERITE_AXE)){
                    ...
                    if(state.isOf(MBMBlocks.CHOPPED_ACACIA_LOG)) {
                        ChangeState = MBMBlocks.CHOPPED_STRIPPED_ACACIA_LOG.getDefaultState();
                        bark_item = MBMItems.ACACIA_BARK_FRAGMENT.asItem();
                    } else if(state.isOf(MBMBlocks.CHOPPED_BIRCH_LOG)) {
                        ChangeState = MBMBlocks.CHOPPED_STRIPPED_BIRCH_LOG.getDefaultState();
                        bark_item = MBMItems.BIRCH_BARK_FRAGMENT.asItem();
                    } else if(state.isOf(MBMBlocks.CHOPPED_DARK_OAK_LOG)) {
                        ChangeState = MBMBlocks.CHOPPED_STRIPPED_DARK_OAK_LOG.getDefaultState();
                        bark_item = MBMItems.DARK_OAK_BARK_FRAGMENT.asItem();
                    } else if(state.isOf(MBMBlocks.CHOPPED_JUNGLE_LOG)) {
                        ChangeState = MBMBlocks.CHOPPED_STRIPPED_JUNGLE_LOG.getDefaultState();
                        bark_item = MBMItems.JUNGLE_BARK_FRAGMENT.asItem();
                    } else if(state.isOf(MBMBlocks.CHOPPED_OAK_LOG)) {
                        ChangeState = MBMBlocks.CHOPPED_STRIPPED_OAK_LOG.getDefaultState();
