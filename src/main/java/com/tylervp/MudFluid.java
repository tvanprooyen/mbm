...
public abstract class MudFluid extends AbstractMudFluid {
	...
	public Fluid getStill() {
		return moreblocksmod.STILL_MUD;
	}
 
	@Override
	public Fluid getFlowing() {
		return moreblocksmod.FLOWING_MUD;
	}
 
	@Override
	public Item getBucketItem() {
		return moreblocksmod.MUD_BUCKET;
	}
 
	@Override
	protected BlockState toBlockState(FluidState fluidState) {
		// method_15741 converts the LEVEL_1_8 of the fluid state to the LEVEL_15 the fluid block uses
		return moreblocksmod.MUD.getDefaultState().with(Properties.LEVEL_15, method_15741(fluidState));
	}
